	...
	<section class="terms-of-use">
		...
		<div class="terms">
			<div class="container">
				...
				<!-- //tittle heading -->
				<p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from www.Buzztro.com (the “Site”). </p>
				...
				<h6>Contact us </h6>
				<p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e mail at Buzztro@gmail.com or by mail using the details provided below: </p>
				<p>Buzztro 
				[Re: Privacy Compliance Officer] 
				Ec-69,b-002, mangal villa evershine city vasai(east), 401208 Mumbai MH, India
				</p>
			</div>
		</div>
		<!-- /terms -->
