      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Manage Featured Product</div>
          <div class="card-body">
            <div class="table-responsive" style="overflow-x: hidden;">
              <form action="../Admin_modules/feature_select.php" method="post">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                          <input type="checkbox" name="feature_sel[]" value="<?php echo $value['prod_id'];?>" style="transform: scale(1.8); padding-top: 15px;">
                      </td>
                    </tr>
