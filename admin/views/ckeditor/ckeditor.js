(function() {
    ...
    (function() {
        function a(a, b) {
            ...
            this.current ? e = this.current[D](!1, p, h) : (a ? e.type == CKEDITOR.NODE_ELEMENT &&
    ...
    (function() {
        ...
        function d(a, b, c, d, f) {
            ...
            function g() {
                var b = O - 1,
                    c = C && w && !p.equals(D);
                b < H - 1 || b < F - 1 || c ? (c ? a.moveToPosition(D,
            ...
            var p = a.startContainer,
                ...
                B = a.endOffset,
                N, q, C, w, v, Q;
            if (l && D.type == CKEDITOR.NODE_TEXT && (p.equals(D) || p.type === CKEDITOR.NODE_ELEMENT && p.getFirst().equals(D))) c.append(a.document.createText(D.substring(G, B)));
            else {
                D.type == CKEDITOR.NODE_TEXT ? l ? Q = !0 : D = D.split(B) : 0 < D.getChildCount() ? B >= D.getChildCount() ? (D = D.getChild(B - 1), q = !0) : D = D.getChild(B) : w = q = !0;
                p.type == CKEDITOR.NODE_TEXT ? l ? v = !0 : p.split(G) : 0 < p.getChildCount() ? 0 === G ? (p = p.getChild(G), N = !0) : p = p.getChild(G - 1) : C = N = !0;
                for (var S = p.getParents(), n = D.getParents(), O = m(),
                        H = S.length - 1, F = n.length - 1, K = c, A, ba, L, da = -1, T = O; T <= H; T++) {
                    ba = S[T];
                    L = ba.getNext();
                    for (T != H || ba.equals(n[T]) && H < F ? b && (A = K.append(ba.clone(0, f))) : N ? h(ba, K, !1, C) : v && K.append(a.document.createText(ba.substring(G))); L;) {
                        if (L.equals(n[T])) {
                            da = T;
                            break
                        }
                ...
                for (T = O; T <= F; T++)
                    if (c = n[T], L = c.getPrevious(), c.equals(S[T])) b && (K = K.getChild(0));
                        ...
                        T != F || c.equals(S[T]) && F < H ? b && (A = K.append(c.clone(0, f))) : q ? h(c, K, !1, w) : Q && K.append(a.document.createText(c.substring(0, B)));
                        if (T > da)
                            for (; L;) L = h(L, K, !0);
                        K = A
                    }
            ...
            enlarge: function(a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        B.type == CKEDITOR.NODE_TEXT ? (q && (B = !CKEDITOR.tools.trim(B.substring(0, q)).length && B, G = !!B), B && ((p = B.getPrevious()) || (l = B.getParent()))) : (q && (p = B.getChild(q - 1) || B.getLast()), p || (l = B));
                        for (l = c(l); l || p;) {
                            if (l && !p) {
                                !D && l.equals(m) && (D = !0);
                                if (f ? l.isBlockBoundary() : !g.contains(l)) break;
                                G && "inline" == l.getComputedStyle("display") || (G = !1, D ? k = l : this.setStartBefore(l));
                                p = l.getPrevious()
                            }
                            for (; p;)
                                if (B = !1, p.type == CKEDITOR.NODE_COMMENT) p = p.getPrevious();
                                else {
                                    if (p.type == CKEDITOR.NODE_TEXT) N = p.getText(), d.test(N) && (p = null), B = /[\s\ufeff]$/.test(N);
                                    else if ((p.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && p.is("br")) && !p.data("cke-bookmark"))
                                        if (G && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                            N = p.getText();
                                            if (d.test(N)) p = null;
                                            else
                                                for (var q = p.$.getElementsByTagName("*"), C = 0, w; w = q[C++];)
                                    ...
                                    B && (G ? D ? k = l : l && this.setStartBefore(l) : G = !0);
                                    if (p) {
                                        B = p.getPrevious();
                                        if (!l && !B) {
                                            l = p;
                        ...
                        l = p = null;
                        D = G = !1;
                        B.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(B.substring(q)).length ? G = !0 : (G = !B.getLength(), q == B.getLength() ? (p = B.getNext()) || (l = B.getParent()) :
                            h(B, q) && (l = B.getParent())) : (p = B.getChild(q)) || (l = B);
                        for (; l || p;) {
                            if (l && !p) {
                                !D && l.equals(m) && (D = !0);
                                if (f ? l.isBlockBoundary() : !g.contains(l)) break;
                                G && "inline" == l.getComputedStyle("display") || (G = !1, D ? u = l : l && this.setEndAfter(l));
                                p = l.getNext()
                            }
                            for (; p;) {
                                B = !1;
                                if (p.type == CKEDITOR.NODE_TEXT) N = p.getText(), h(p, 0) || (p = null), B = /^[\s\ufeff]/.test(N);
                                    ...
                                    if ((0 < p.$.offsetWidth || b && p.is("br")) && !p.data("cke-bookmark"))
                                        if (G && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                            ...
                                            if (d.test(N)) p =
                                                ...
                                                for (q = p.$.getElementsByTagName("*"), C = 0; w = q[C++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[w.nodeName.toLowerCase()]) {
                                                        p = null;
                                                        break
                                                    }
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var v, Q, S = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                                br: 1
                            } : null),
                            n = null,
                            O = function(a) {
                        ...
                        l = l.lastBackward();
                        v = v || g;
                        this.setStartAt(v, !v.is("br") && (!l && this.checkStartOfBlock() || l && v.contains(l)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
                        ...
                        l = new CKEDITOR.dom.walker(l);
                        l.guard =
                            a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? f : O;
                        v = n = Q = null;
                        l = l.lastForward();
                        v = v || g;
                        this.setEndAt(v, !l && this.checkEndOfBlock() || l && v.contains(l) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START);
                ...
                if (!this.collapsed) {
                    ...
                    h.guard = function(b, c) {
                        ...
                        if (a == CKEDITOR.SHRINK_ELEMENT &&
                            b.type == CKEDITOR.NODE_TEXT || c && b.equals(G) || !1 === d && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable")) return !1;
            ...
            getNextParagraph: function(a) {
                ...
                for (this._.nextNode = null; m;) {
                    ...
                    if (k && !M)
                        for (; !m.getNext(g) && !t;) {
                            p = m.getParent();
                            if (p.isBlockBoundary(this.forceBrBreak && !y && {
                                    br: 1
                                })) {
                                M = 1;
                                J = 0;
    ...
    (function() {
        function a(a, b, c, d, e) {
            ...
            for (f in b) {
                ...
                for (q in Q) {
                    ...
                    var h = n,
                        ...
                        O = void 0;
                    g ? D = !1 : g = {};
                    for (O in H) "!" == O.charAt(0) && (O = O.slice(1), v.push(O), g[O] = !0, D = !1);
                    for (; O = v.pop();) H[O] =
                        H["!" + O], delete H["!" + O];
                    h[m] = (D ? !1 : g) || null
                }
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (q in S) {
                    ...
                    g = [];
                    H = void 0;
                    for (H in m) - 1 < H.indexOf("*") ? g.push(new RegExp("^" + H.replace(/\*/g, ".*") + "$")) : g.push(H);
                    m = g;
                    m.length && (n[w] = m, h = !1)
                }
                n.nothingRequired = h;
        ...
        function e(a) {
            var b, c, d, e, f = {},
                p = 1;
            for (a = w(a); b = a.match(n);)(c = b[2]) ? (d = x(c, "styles"), e = x(c, "attrs"), c = x(c, "classes")) : d = e = c = null, f["$" + p++] = {
                elements: b[1],
                classes: c,
                styles: d,
                attributes: e
            ...
            if (f.doFilter) {
                a: {
                    ...
                    if (a || w) {
                        ...
                        if (h)
                            for (v = 0, C = h.length; v < C; ++v) c(h[v], b, k);
                        if (a)
                            for (v = 0, C = a.length; v < C; ++v) d(a[v], b, k, g);
                        if (w)
                            for (v = 0, C = w.length; v < C; ++v) d(w[v], b, k, g);
                        a = k
                    } else a = null
                }
                ...
                var B = b.styleBackup,
                    G, l, K = [],
                    k = [],
                    N = /^data-cke-/;v = !1;delete q.style;delete q["class"];delete b.classBackup;delete b.styleBackup;
                if (!a.allAttributes)
                    for (G in q) C[G] || (N.test(G) ? G == (l = G.replace(/^data-cke-saved-/, "")) || C[l] || (delete q[G], v = !0) : (delete q[G], v = !0));
                ...
                if (!a.allClasses ||
                    a.hadInvalidClass) {
                    for (G = 0; G < h.length; ++G)(a.allClasses || w[h[G]]) && k.push(h[G]);
                    k.length && (q["class"] = k.sort().join(" "));
                    g && k.length < g.split(/\s+/).length && (v = !0)
                } else g && (q["class"] = g);v && (n = 1);
        ...
        function E(a, b, c) {
            ...
            if (q.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(y()) : (a.parent && c.push({
                ...
                if ("br" == b) a.previous && !J(a.previous) && (b = y(), b.insertBefore(a)), a.next && !J(a.next) && (b = y(), b.insertAfter(a)), a.replaceWithChildren();
                else {
                    var d = a.children,
                        e;
                    b: {
                    ...
                    if (e) a.name = b, a.attributes = {}, c.push({
                        ...
                        e = a.parent;
                        for (var f = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, w, h, p = d.length; 0 < p;) n = d[--p], f && (n.type == CKEDITOR.NODE_TEXT || n.type == CKEDITOR.NODE_ELEMENT && q.$inline[n.name]) ? (w || (w = new CKEDITOR.htmlParser.element(b), w.insertAfter(a), c.push({
                            check: "parent-down",
                            el: w
                        })), w.add(n, 0)) : (w = null, h = q[e.name] || q.span, n.insertAfter(a), e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || n.type != CKEDITOR.NODE_ELEMENT || h[n.name] || c.push({
                            check: "el-up",
                            el: n
                        }));
                        a.remove()
        ...
        function D(a, b) {
            ...
            for (f in d)
                if ("class" == f)
                    for (c = d[f].split(/\s+/), n = a.classes.join("|"); w = c.pop();) {
        ...
        CKEDITOR.filter = function(a, b) {
            ...
            if (c && !b) {
                ...
                !0 === d ? this.disabled = !0 : (d || (this.customConfig = !1), this.allow(d, "config", 1), this.allow(c.config.extraAllowedContent, "extra", 1), this.allow(v[c.enterMode] +
        ...
        CKEDITOR.filter.prototype = {
            ...
            applyTo: function(a, b, c, d) {
                ...
                a.forEach(function(a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        a: {
                            ...
                            1 == d.children.length && (A = d.children[0]).type == CKEDITOR.NODE_ELEMENT && z(e, A, c, h);
                            c = !c.length
                        }
                        c || f.push(a)
                    }
                ...
                for (var k; c = f.pop();) c.type == CKEDITOR.NODE_ELEMENT ? E(c, d, a) : c.remove();
                for (; g = a.pop();)
                    if (c = g.el, c.parent) switch (k = q[c.parent.name] || q.span, g.check) {
                        case "it":
                            q.$removeEmpty[c.name] && !c.children.length ? E(c, d, a) : m(c) || E(c, d, a);
                            break;
                        case "el-up":
                            c.parent.type ==
                                CKEDITOR.NODE_DOCUMENT_FRAGMENT || k[c.name] || E(c, d, a);
                            break;
                        case "parent-down":
                            c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || k[c.name] || E(c.parent, d, a)
                    }
                    return w
            },
                ...
                if (!this.disabled && a) {
                    ...
                    for (e = 0; e < a.length; ++e) {
                        ...
                        var f = void 0,
                            ...
                            h = void 0;
                        c = [];
                        for (p = 0; p < b.length; ++p) n = b[p], "string" == typeof n ? (n = n.split(/\s*:\s*/), w = n[0], q = null, h = n[1]) : (w = n.check, q = n.left, h = n.right), f || (f = n, f = f.element ? f.element : w ? w.match(/^([a-z0-9]+)/i)[0] :
                            f.left.getDefinition().element), q instanceof CKEDITOR.style && (q = B(q)), c.push({
                            check: w == f ? null : w,
                            left: q,
            ...
            check: function(a, b, c) {
                ...
                } else f = a.getDefinition(), w = f.styles, d = f.attributes || {}, w && !CKEDITOR.tools.isEmpty(w) ? (w = C(w), d.style = CKEDITOR.tools.writeCssText(w, !0)) : w = {}, f = {
                    name: f.element,
                    attributes: d,
                ...
                0 < q.length ? c = !1 : ((b = f.attributes["class"]) && (f.attributes["class"] = f.attributes["class"].split(" ").sort().join(" ")), c = CKEDITOR.tools.objectCompare(f.attributes, w.attributes, !0), b && (f.attributes["class"] = b));
            ...
            transform: function(a, b) {
                if ("string" == typeof b) a.name = b;
                    ...
                    for (e in f)
                        if ("class" == e)
                            for (c =
                                a.classes.join("|"), n = f[e].split(/\s+/); w = n.pop();) - 1 == c.indexOf(w) && a.classes.push(w);
        ...
        function x(a) {
            ...
            CKEDITOR.plugins.load(d.split(","), function(b) {
                ...
                for (var p in b) {
                    ...
                    if (n && (O = n.match(g)))
                        for (; n = O.pop();) CKEDITOR.error("editor-plugin-required", {
                            plugin: n.replace(",", ""),
                            requiredBy: p
                        });
                    k && !a.lang[p] && (k.split && (k = k.split(",")), 0 <= CKEDITOR.tools.indexOf(k, a.langCode) ? D = a.langCode : (D = a.langCode.replace(/-.*/, ""), D =
                        D != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, D) ? D : 0 <= CKEDITOR.tools.indexOf(k, "en") ? "en" : k[0]), h.langEntries && h.langEntries[D] ? (a.lang[p] = h.langEntries[D], D = null) : f.push(CKEDITOR.getUrl(h.path + "lang/" + D + ".js")));
                    e.push(D);
                    d.push(h)
                }
        ...
        function z(a, b) {
            ...
            for (var e = new CKEDITOR.dom.documentFragment, f, h, g, k = 0; k < a.length; k++) {
                ...
                c(l) ? (f || (f = q.getAscendant("table").clone(), f.append(q.getAscendant({
                    ...
                    tbody: 1,
                    tfoot: 1
                }).clone()), e.append(f), f = f.findOne("thead, tbody, tfoot")), h && h.equals(q) || (h =
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(h, k, g) {
                function l(a) {
                    ...
                    if (0 < m.length)
                        for (var c = 0; c < m.length; c++) {
                            ...
                            h && !h[e] || a && f && !f[a] && CKEDITOR.dtd[a] ? e == y.name && (x(y, y.parent, 1), c--) : (b || (u(), b = 1), d = d.clone(), d.parent = y, y = d, m.splice(c, 1), c--)
                        }
                }
                ...
                function x(b, c, d) {
                    c = c || y || r;
                    var f = y;
                    void 0 === b.previous && (t(c, b) && (y = c, I.onTagOpen(g, {}), b.returnPoint = c = y), e(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (E = !1), "textarea" == b.name && (J = !1));
                ...
                I.onTagOpen = function(e, f, h, g) {
                    ...
                    if (a(f)) m.push(f);
                        ...
                        if ("br" == e) M.push(f);
                            ...
                            else if (h in CKEDITOR.dtd.$inline && m.unshift(y), y.parent) x(y, y.parent, 1);
                            else {
                                f.isOrphan = 1;
                                break
                            }
                ...
                I.onTagClose = function(a) {
                    ...
                    for (var c = [], d = [], e = y; e != r && e.name != a;) e._.isBlockLike || d.unshift(e), c.push(e), e = e.returnPoint || e.parent;
                    if (e != r) {
                ...
                I.onText = function(a) {
                    if (!(y._.hasInlineStarted && !M.length || E || J) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return;
                    var b = y.name,
    ...
    (function() {
                ...
                return function(f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var n = [],
                            ...
                            g, A;
                        if (q)
                            for (w(q, 1) && n.push(q); q;) h(q) && (g = c(q)) && w(g) && ((A = c(g)) && !h(A) ? n.push(g) : (e(p).insertAfter(g), g.remove())), q = q.previous;
        ...
        function u(a) {
            return a.replace(C,
                function(a, b, c) {
                    return "\x3c" + b + c.replace(w, function(a, b) {
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function(a, b, c, d) {
                var e = this.editor,
                    f, n, q, w;
                b && "object" == typeof b ? (f = b.context, c = b.fixForBody, d = b.dontFilter, n = b.filter, q = b.enterMode, w = b.protectedWhitespaces) : f = b;
        ...
        var C = /<(a|area|img|input|source)\b([^>]*)>/gi,
            ...
            O = new RegExp("(" + z("\x3ccke:encoded\x3e") + "(.*?)" + z("\x3c/cke:encoded\x3e") + ")|(" + z("\x3c") + z("/") + "?" + z("cke:encoded\x3e") + ")", "gi"),
    ...
    (function() {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    if (f)
                        for (;
                            (g = b.getCommonAncestor(0, 1)) && (w = CKEDITOR.dtd[g.getName()]) && (!w || !w[e]);)
                            if (g.getName() in
                                CKEDITOR.dtd.span) {
        ...
        m = function() {
            ...
            function b(c, d) {
                ...
                e = d.range.startPath();
                for (var k = w[k.getName()], C = 0, v = c.getChildren(), l = v.count(), m = -1, u = -1, Q = 0, B = e.contains(w.$list); C <
                    l; ++C) e = v.getItem(C), a(e) ? (q = e.getName(), B && q in CKEDITOR.dtd.$list ? h = h.concat(b(e, d)) : (g = !!k[q], "br" != q || !e.data("cke-eol") || C && C != l - 1 || (Q = (f = C ? h[C - 1].node : v.getItem(C + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && w.$block[f.getName()]), -1 != m || g || (m = C), g || (u = C), h.push({
                    isElement: 1,
                    isLineBreak: Q,
            ...
            function d(b, c) {
                ...
                for (C && e.push(" "); h < q; h++) g = f.getItem(h), a(g) && !g.is(k) ? e = e.concat(d(g, c)) : e.push(g);
                C && e.push(" ");
                return e
            }
            ...
            function f(b) {
                return b && a(b) && (b.is(w.$removeEmpty) || b.is("a") && !b.isBlockBoundary())
            }
            ...
            function q(b, c, d, e) {
                ...
                (g = (new CKEDITOR.dom.walker(f)).next()) && a(g) && v[g.getName()] &&
            ...
            return function(n, v, H, F) {
                ...
                if (!F.checkReadOnly()) {
                    var t = (new CKEDITOR.dom.elementPath(F.startContainer, F.root)).blockLimit || F.root;
                    v = {
                        type: v,
                        dontFilter: A,
                        editable: n,
                    ...
                    var A = v.range,
                        ...
                        r, x, z, y, I, U;
                    "text" == v.type &&
                        A.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (x = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", A.document), A.insertNode(x), A.setStartAfter(x));
                    ...
                    if (!A.collapsed) {
                        ...
                        r && !r.equals(aa) && !r.contains(aa) && A.checkEndOfBlock() && v.zombies.push(r);
                        A.deleteContents()
                    }
                    for (;
                        (I = e(A)) && a(I) && I.isBlockBoundary() && z.contains(I);) A.moveToPosition(I,
                        CKEDITOR.POSITION_BEFORE_END);
                    q(A, v.blockLimit, z, y);
                    x && (A.setEndBefore(x), A.collapse(), x.remove());
                    x = A.startPath();
                    if (r = x.contains(f, !1, 1)) U = A.splitElement(r), v.inlineStylesRoot = r, v.inlineStylesPeak = x.lastElement;
                    x = A.createBookmark();
                    L && (l(r), l(U));
                    ...
                    A.moveToBookmark(x);
                    K.enterMode === CKEDITOR.ENTER_DIV && "" === K.getData(!0) && ((K = n.getFirst()) && K.remove(),
                        F.setStartAt(n, CKEDITOR.POSITION_AFTER_START), F.collapse(!0));
                    if (n = H) {
                        n = v.range;
                        if ("text" == v.type && v.inlineStylesRoot) {
                            F = v.inlineStylesPeak;
                            K = F.getDocument().createText("{cke-peak}");
                            for (U = v.inlineStylesRoot.getParent(); !F.equals(U);) K = K.appendTo(F.clone()), F = F.getParent();
                        ...
                        if ((J = n.startPath().block) && (1 != J.getChildCount() || !J.getBogus())) a: {
                            var P;
                            if (1 == F.getChildCount() && a(P = F.getFirst()) && P.is(m) && !P.hasAttribute("contenteditable")) {
                    ...
                    if (n) {
                        ...
                        for (h(K, P); U < K.length; U++) {
                            A = K[U];
                            if (L = A.isLineBreak) L = P, r = F, y = z = void 0, A.hasBlockSibling ? L = 1 : (z = L.startContainer.getAscendant(w.$block, 1)) && z.is({
                                div: 1,
                                p: 1
                            }) ? (y = z.getPosition(r), y ==
                                CKEDITOR.POSITION_IDENTICAL || y == CKEDITOR.POSITION_CONTAINS ? L = 0 : (r = L.splitElement(z), L.moveToPosition(r, CKEDITOR.POSITION_AFTER_START), L = 1)) : L = 0;
                            if (L) H = 0 < U;
                            else {
                                L = P.startPath();
                                !A.isBlock && k(v.editor, L.block, L.blockLimit) && (M = g(v.editor)) && (M = n.createElement(M), M.appendBogus(), P.insertNode(M), CKEDITOR.env.needsBrFiller && (R = M.getBogus()) && R.remove(), P.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END));
                                ...
                                if (x && A.isElement) {
                                    ...
                                    if (L) r && (Y = P.splitElement(r), v.zombies.push(Y), v.zombies.push(r));
                                    else {
                                        r = F.getName();
                                        Z = !U;
                                        L = U == K.length - 1;
                                        ...
                                        z = [];
                                        y = r.length;
                                        for (var aa = 0, ca = void 0, W = 0, V = -1; aa < y; aa++) ca = r[aa], " " == ca ? (W || Z && !aa || (z.push(new CKEDITOR.dom.text(" ")), V = z.length), W = 1) : (z.push(ca), W = 0);
                                        L && V == z.length && z.pop();
                                        Z = z
                                    }
                                }
                                ...
                                A.lastNotAllowed && U < K.length - 1 && ((Y = t ? I : Y) && P.setEndAt(Y, CKEDITOR.POSITION_AFTER_START), x = 0);
                                P.collapse()
                            }
                        }
                        1 != K.length ? R = !1 : (R = K[0], R = R.isElement && "false" == R.node.getAttribute("contenteditable"));
                        R && (H = !0, L = K[0].node, P.setStartAt(L, CKEDITOR.POSITION_BEFORE_START), P.setEndAt(L, CKEDITOR.POSITION_AFTER_END));
                        v.dontMoveCaret = H;
                    ...
                    for (Z = R.createBookmark(); E = v.zombies.pop();) E.getParent() && (M = R.clone(), M.moveToElementEditStart(E), M.removeEmptyBlocksAtEnd());
                    if (Y)
                        for (; E = Y.pop();) CKEDITOR.env.needsBrFiller ? E.appendBogus() : E.append(R.document.createText(" "));
                    for (; E = v.mergeCandidates.pop();) E.mergeSiblings();
                    R.moveToBookmark(Z);
                    if (!v.dontMoveCaret) {
                        for (E = e(R); E && a(E) && !E.is(w.$empty);) {
                            if (E.isBlockBoundary()) R.moveToPosition(E, CKEDITOR.POSITION_BEFORE_END);
                            else {
                ...
                table: function() {
                    function a(c) {
                        ...
                        g.guard = function(a, g) {
                            ...
                            else if (!g && n && a.equals(n)) f = c.clone(), f.setStartAt(n, CKEDITOR.POSITION_AFTER_START), e.push(f);
                            else {
                    ...
                    return {
                        ...
                        detectRanges: function(e, f) {
                            ...
                            l = l.contains("table");
                            n = n.contains("table");
                            if (l || n) l && n && b(l, n) ? (e.tableSurroundingRange =
    ...
    (function() {
            ...
            if (b) {
                ...
                if (!(e = !c) && (e = !c.isHidden())) {
                    ...
                    var f = c.getRanges(),
                        ...
                        H = 1 === g.length && g[0]._getTableElement() && g[0]._getTableElement().is("table");
        ...
        function l(a) {
            return G(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? !0 : !1
        }
        ...
        var m = "function" != typeof window.getSelection,
            ...
            J = new RegExp(y + "( )?", "g"),
            E, p, D, G = CKEDITOR.dom.walker.invisible(1),
            B = function() {
                function a(b) {
                    return function(a) {
                        var c =
        ...
        CKEDITOR.on("instanceCreated", function(a) {
            ...
            c.on("contentDom", function() {
                ...
                CKEDITOR.env.gecko && g.attachListener(g, "focus", function(a) {
                    a.removeListener();
                    0 !== C && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == g.$ && (a = c.createRange(), a.moveToElementEditStart(g),
                        a.select())
                }, null, null, -2);
                g.attachListener(g, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusin" : "focus", function() {
                    if (C && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                        C = c._.previousActive && c._.previousActive.equals(e.getActive());
                        var a = null != c._.previousScrollTop && c._.previousScrollTop != g.$.scrollTop;
                        CKEDITOR.env.webkit && C && a && (g.$.scrollTop = c._.previousScrollTop)
                    }
                    c.unlockSelection(C);
                    C = 0
                }, null, null, -1);
                ...
                if (CKEDITOR.env.ie || CKEDITOR.env.gecko || A) m ? g.attachListener(g,
                    "beforedeactivate", a, null, null, -1) : g.attachListener(c, "selectionCheck", a, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusout" : "blur", function() {
                    var a = p && (p.isFake || 2 > p.getRanges());
                    CKEDITOR.env.gecko && !A && a || (c.lockSelection(p), C = 1)
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getRanges: function() {
                var a = m ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        for (var e = d.children, f, g, h = b.duplicate(), k = 0, l = e.length - 1, q = -1, m, p; k <= l;)
                    ...
                    return function() {
                        ...
                        if (d == CKEDITOR.SELECTION_ELEMENT) {
                            for (var d = [], e = 0; e < c.length; e++) {
                                for (var f =
                                        c.item(e), g = f.parentNode, h = 0, a = new CKEDITOR.dom.range(this.root); h < g.childNodes.length && g.childNodes[h] != f; h++);
            ...
            getSelectedText: function() {
                ...
                var b = this.getNative(),
                    b = m ? "Control" == b.type ? "" : b.createRange().text :
                    b.toString();
            ...
            unlock: function(a) {
                if (this.isLocked) {
                    ...
                    this.isLocked = 0;
                    this.reset();
                    a && (a = b || c[0] && c[0].getCommonAncestor()) && a.getAscendant("body", 1) && (this.root.editor.plugins.tableselection && d(c) ? f.call(this, c) : e ? this.fake(b) : b && 2 > c.length ? this.selectElement(b) :
                        this.selectRanges(c))
                }
            },
            reset: function() {
            ...
            selectRanges: function(a) {
                ...
                if (a.length)
                    if (this.isLocked) {
                        ...
                        a: {
                            var l, H;
                            if (1 == a.length && !(H = a[0]).collapsed && (n = H.getEnclosedNode()) && n.type == CKEDITOR.NODE_ELEMENT &&
                                (H = H.clone(), H.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (l = H.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (n = l), "false" == n.getAttribute("contenteditable"))) break a;
                            n = void 0
                        }
                        if (n) this.fake(n);
                        else if (b && b.plugins.tableselection && b.plugins.tableselection.isSupportedEnvironment() && d(a) && !E && !a[0]._getTableElement({
                                table: 1
                            ...
                            if (m) {
                                ...
                                if (b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.getName() in H || b.endContainer.type == CKEDITOR.NODE_ELEMENT && b.endContainer.getName() in H) b.shrink(CKEDITOR.NODE_ELEMENT, !0), a = b.collapsed;
                                A = b.createBookmark();
                                H = A.startNode;
                                a || (k = A.endNode);
                                ...
                                k ? (n = b.document.$.body.createTextRange(), n.moveToElementText(k.$), A.setEndPoint("EndToEnd", n), A.moveEnd("character", -1)) : (F = H.getNext(l), p = H.hasAscendant("pre"), F = !(F && F.getText && F.getText().match(n)) && (p || !H.hasPrevious() || H.getPrevious().is && H.getPrevious().is("br")), p = b.document.createElement("span"), p.setHtml("\x26#65279;"), p.insertBefore(H), F && b.document.createText("﻿").insertBefore(H));
                                b.setStartBefore(H);
                                H.remove();
                                a ? (F ? (A.moveStart("character", -1), A.select(), b.document.$.selection.clear()) : A.select(), b.moveToPosition(p, CKEDITOR.POSITION_BEFORE_START), p.remove()) : (b.setEndBefore(k), k.remove(), A.select())
                            } else {
                                k = this.getNative();
                                if (!k) return;
                                ...
                                for (A = 0; A < a.length; A++) {
                                    ...
                                    b.collapsed && CKEDITOR.env.webkit && u(b) && (n = e(this.root), b.insertNode(n), (F = n.getNext()) && !n.getPrevious() && F.type == CKEDITOR.NODE_ELEMENT && "br" == F.getName() ? (x(this.root), b.moveToPosition(F, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(n, CKEDITOR.POSITION_AFTER_END));
                                    p.setStart(b.startContainer.$, b.startOffset);
                                    try {
                                        p.setEnd(b.endContainer.$, b.endOffset)
                                    } catch (t) {
                                        if (0 <=
                                            t.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) b.collapse(1), p.setEnd(b.endContainer.$, b.endOffset);
                                        else throw t;
                                    }
                                    k.addRange(p)
                                }
    ...
    (function() {
                ...
                for (t.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (t = 0); t;) {
                    ...
                    if (t.equals(r)) t = null, l = !0;
                        ...
                        if (v && m && CKEDITOR.dtd.$block[z])
                            for (var D = t, B = f(D), C = void 0, E = B.length, G = 0, D = E && new CKEDITOR.dom.range(D.getDocument()); G < E; ++G) {
                                var C = B[G],
                                    J = CKEDITOR.filter.instances[C.data("cke-filter")];
                                if (J ? J.check(this) : 1) D.selectNodeContents(C), b.call(this, D)
                            }
                        B = z ? !p[z] || y ? 0 : v && !m ? 0 : d(t, r, h, Q) : 1;
                        if (B)
                            if (C = t.getParent(), B = h, E = g, G = k, !C || !(C.getDtd() || CKEDITOR.dtd.span)[E] && !G || B.parentRule &&
                                !B.parentRule(C)) l = !0;
                            else {
                                if (x || z && CKEDITOR.dtd.$removeEmpty[z] && (t.getPosition(r) | Q) != Q || (x = c.clone(), x.setStartBefore(t)), z = t.type, z == CKEDITOR.NODE_TEXT || v || z == CKEDITOR.NODE_ELEMENT && !t.getChildCount()) {
                                    for (var z = t, N;
                                        (l = !z.getNext(w)) && (N = z.getParent(), p[N.getName()]) && d(N, u, h, S);) z = N;
                                    x.setEndAfter(z)
                                }
                            } else l = !0;
                        ...
                        for (var l = M(this, e), v = l.hasAttributes(), y = x.getCommonAncestor(), z = {}, B = {}, C = {}, E = {}, W, V, X; l && y;) {
                            if (y.getName() == g) {
                                for (W in h.attributes) !E[W] &&
                                    (X = y.getAttribute(V)) && (l.getAttribute(W) == X ? B[W] = 1 : E[W] = 1);
                                for (V in h.styles) !C[V] && (X = y.getStyle(V)) && (l.getStyle(V) == X ? z[V] = 1 : C[V] = 1)
                            }
                            y = y.getParent()
                        }
            ...
            if (a.collapsed) {
                for (var f = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, h = 0, k; h < f.elements.length && (k = f.elements[h]) && k != f.block && k != f.blockLimit; h++)
                    if (this.checkElementRemovable(k)) {
                        var l;
                        !e && a.collapsed && (a.checkBoundaryOfElement(k, CKEDITOR.END) || (l = a.checkBoundaryOfElement(k, CKEDITOR.START))) ? (g = k, g.match = l ? "start" : "end") : (k.mergeSiblings(), k.is(this.element) ? z.call(this, k) : r(k, E(this)[k.getName()]))
                    }
                if (g) {
                    e =
                        d;
                ...
                var m = c.endNode,
                    p = this;
                b();
                for (f = d; !f.equals(m);) g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? z.call(this, f) : r(f, E(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())), f = g
            }
            a.moveToBookmark(c);
        ...
        function u(a, b) {
            ...
            if (d) {
                var c = b,
                    k;
                (k = c.getPrevious(v)) && k.type == CKEDITOR.NODE_ELEMENT && k.is("pre") && (d = x(k.getHtml(), /\n$/, "") + "\n\n" + x(c.getHtml(), /^\n/, ""), CKEDITOR.env.ie ? c.$.outerHTML = "\x3cpre\x3e" + d + "\x3c/pre\x3e" :
        ...
        function I(a) {
            for (var b = E(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || z.call(this, d, !0);
            for (var f in b)
                if (f != this.element)
        ...
        var B = {
            ...
            q = /\s*(?:;\s*|$)/,
            C = /#\((.+?)\)/g,
            w = CKEDITOR.dom.walker.bookmark(0,
                1),
        ...
        CKEDITOR.style = function(a, b) {
            ...
            this.type = a.type || (B[c] ? CKEDITOR.STYLE_BLOCK : N[c] ? CKEDITOR.STYLE_OBJECT :
        ...
        CKEDITOR.style.prototype = {
            apply: function(a) {
                if (a instanceof CKEDITOR.dom.document) return G.call(this, a.getSelection());
            ...
            remove: function(a) {
                if (a instanceof CKEDITOR.dom.document) return G.call(this, a.getSelection(), 1);
            ...
            checkElementMatch: function(a, b) {
                ...
                if ("string" == typeof this.element ? d == this.element : d in this.element) {
                    ...
                    if (c._length) {
                        for (var h in c)
                            if ("_length" != h)
                                if (d = a.getAttribute(h) || "", "style" == h ? D(c[h], d) : c[h] == d) {
                                    if (!b) return !0
                                } else if (b) return !1;
                        if (b) return !0
                    } else return !0
    ...
    (function() {
        ...
        function aa(a) {
            function b(b) {
                ...
                if (d == CKEDITOR.DIALOG_RESIZE_HEIGHT || d == CKEDITOR.DIALOG_RESIZE_BOTH) l = Math.max(e.minHeight || 0, B - h);
                a.resize(q, l);
            ...
            if (d != CKEDITOR.DIALOG_RESIZE_NONE) {
                var f = a.getParentEditor(),
                    g, h, p, n, k, q, l = CKEDITOR.tools.addFunction(function(d) {
                        function e(a) {
                            return a.isVisible()
                        }
                        k = a.getSize();
                        var f = a.parts.contents,
                            ...
                            w = !(CKEDITOR.env.gecko || CKEDITOR.env.ie &&
                                CKEDITOR.env.quirks);
                ...
                a.on("load", function() {
                    ...
                    b = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_resizer' + b + " cke_resizer_" + f.lang.dir + '" title\x3d"' + CKEDITOR.tools.htmlEncode(f.lang.common.resize) + '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + l + ', event )"\x3e' + ("ltr" ==
                        f.lang.dir ? "◢" : "◣") + "\x3c/div\x3e");
        ...
        function O(a) {
            var b = a.config,
                ...
                e = b.dialog_backgroundCoverColor || ("moono-lisa" ==
                    c ? "black" : "white"),
            ...
            f ? f.show() : (d = ['\x3cdiv tabIndex\x3d"-1" style\x3d"position: ', CKEDITOR.env.ie6Compat ? "absolute" : "fixed", "; z-index: ", d, "; top: 0px; left: 0px; ", "; width: 100%; height: 100%;", CKEDITOR.env.ie6Compat ? "" : "background-color: " + e, '" class\x3d"cke_dialog_background_cover"\x3e'], CKEDITOR.env.ie6Compat && (e = "\x3chtml\x3e\x3cbody style\x3d\\'background-color:" +
                ...
                f.setOpacity(void 0 !== c ? c : .5), f.on("keydown", J), f.on("keypress", J), f.on("keyup", J), f.appendTo(CKEDITOR.document.getBody()), C[b] = f);
        ...
        var x = CKEDITOR.tools.cssLength,
            ...
            X = '\x3cdiv class\x3d"cke_reset_all cke_dialog_container {editorId} {editorDialogClass} {hidpi}" dir\x3d"{langDir}" style\x3d"' +
        ...
        CKEDITOR.dialog = function(a, b) {
            ...
            function d(b) {
                if (m == CKEDITOR.dialog._.currentTop) {
                    ...
                    else if (c == CKEDITOR.ALT + 121 && !m._.tabBarMode && 1 < m.getPageCount()) m._.tabBarMode = !0, m._.tabs[m._.currentTabId][0].focus(), m._.currentFocusIndex = -1, q = 1;
                    else if (-1 != CKEDITOR.tools.indexOf(g,
                            c) && m._.tabBarMode) c = -1 != CKEDITOR.tools.indexOf([d ? 39 : 37, 38], c) ? z.call(m) : D.call(m), m.selectPage(c), m._.tabs[c][0].focus(), q = 1;
            ...
            var g = CKEDITOR.dialog._.dialogDefinitions[b],
                ...
                k = {},
                q, l;
            ("OS" == p && CKEDITOR.env.mac || "rtl" == p && "ltr" == n || "ltr" == p && "rtl" == n) && h.buttons.reverse();
            ...
            this.on("show", function() {
                ...
                a.config.dialog_startupFocusTab && b ? (m._.tabBarMode = !0, m._.tabs[m._.currentTabId][0].focus(), m._.currentFocusIndex = -1) : this._.hasFocus ||
            ...
            for (n = 0; n < g.contents.length; n++)(k = g.contents[n]) && this.addPage(k);
        ...
        CKEDITOR.dialog.prototype = {
            ...
            move: function(a, b, c) {
                ...
                this._.position && this._.position.x == a && this._.position.y == b ? (a = Math.floor(p * h.width), b =
                    Math.floor(f * h.height)) : N(this, a, b);
                this._.position = {
                    x: a,
                    y: b
                };
            ...
            show: function() {
                var a = this._.element,
                    b = this.definition;
                a.getParent() && a.getParent().equals(CKEDITOR.document.getBody()) ? a.setStyle("display", F ? "flex" : "block") : a.appendTo(CKEDITOR.document.getBody());
                ...
                null === CKEDITOR.dialog._.currentTop ? (CKEDITOR.dialog._.currentTop = this, this._.parentDialog = null, O(this._.editor)) : (this._.parentDialog = CKEDITOR.dialog._.currentTop,
                    this._.parentDialog.getElement().getFirst().$.style.zIndex -= Math.floor(this._.editor.config.baseFloatZIndex / 2), CKEDITOR.dialog._.currentTop = this);
                a.on("keydown", R);
                a.on("keyup", S);
                this._.hasFocus = !1;
                    ...
                    if (b.contents[c]) {
                        ...
                        if (e) {
                            for (var g in this._.contents[a.id]) {
                                ...
                                "hbox" != h.type && "vbox" != h.type && h.getInputElement() && (h.requiredContent && !this._.editor.activeFilter.check(h.requiredContent) ?
            ...
            hide: function() {
                if (this.parts.dialog.isVisible()) {
                    ...
                    for (ca(this); CKEDITOR.dialog._.currentTop != this;) CKEDITOR.dialog._.currentTop.hide();
            ...
            addPage: function(a) {
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    ...
                    a.accessKey && (T(this, this, "CTRL+" + a.accessKey, da, ea), this._.accessKeyMap["CTRL+" + a.accessKey] = a.id)
                }
            },
        ...
        var C = {},
            ...
            R = function(a) {
                ...
                (b = y[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (e ? "SHIFT+" : "") + d]) && b.length && (b = b[b.length - 1], b.keydown && b.keydown.call(b.uiElement, b.dialog, b.key), a.data.preventDefault())
            },
            S = function(a) {
                var b = a.data.$.ctrlKey || a.data.$.metaKey,
                    c = a.data.$.altKey,
                    e = a.data.$.shiftKey,
                    d = String.fromCharCode(a.data.$.keyCode);
                (b = y[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (e ? "SHIFT+" : "") + d]) && b.length && (b = b[b.length - 1], b.keyup && (b.keyup.call(b.uiElement, b.dialog, b.key), a.data.preventDefault()))
            },
            ...
            ca = function(a) {
                for (var b in y) {
                    for (var c = y[b], e = c.length - 1; 0 <= e; e--) c[e].dialog != a && c[e].uiElement != a || c.splice(e, 1);
            ...
            CKEDITOR.ui.dialog = {
                uiElement: function(a, b, c, e, d, f, g) {
                    if (!(4 > arguments.length)) {
                        ...
                        b.requiredContent && !a.getParentEditor().filter.check(b.requiredContent) && (n.display = "none", this.notAllowed = !0);
                        k.id = l;
                        var r = {};
                        ...
                        for (var m = k["class"] && k["class"].split ? k["class"].split(" ") : [], l = 0; l < m.length; l++) m[l] && (r[m[l]] = 1);
                        m = [];
                        for (l in r) m.push(l);
                        k["class"] = m.join(" ");
                        b.title && (k.title = b.title);
                        r = (b.style || "").split(";");
                        b.align && (m = b.align, n["margin-left"] = "left" == m ? 0 : "auto", n["margin-right"] = "right" == m ? 0 : "auto");
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this,
                            ...
                            function() {
                                ...
                                for (p = 0; p < c.length; p++) {
                                    ...
                                    g ? g[p] && e.push("width:" + x(g[p])) : e.push("width:" + Math.floor(100 / c.length) + "%");
                                    h && e.push("height:" + x(h));
                                    d && void 0 !== d.padding && e.push("padding:" + x(d.padding));
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this, a, d || {
                            ...
                            for (var e = 0; e < c.length; e++) {
                                ...
                                h ? k.push("height:" + x(h[e])) : d && d.expand && k.push("height:" + Math.floor(100 / c.length) + "%");
                                d && void 0 !== d.padding && k.push("padding:" + x(d.padding));
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            openDialog: function(a, b, c) {
                ...
                if ("function" == typeof d) d = this._.storedDialogs || (this._.storedDialogs = {}), e = d[a] || (d[a] = new CKEDITOR.dialog(this, a)), e.setModel(c), b && b.call(e, e), e.show();
                    ...
                    if ("failed" == d) throw P(this), Error('[CKEDITOR.dialog.openDialog] Dialog "' + a + '" failed when loading definition.');
    ...
    (function() {
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            getRangeAtDropPosition: function(a, b) {
                ...
                if (document.caretRangeFromPoint && b.document.$.caretRangeFromPoint(d, g)) c = b.document.$.caretRangeFromPoint(d, g), e.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset),
                    e.collapse(!0);
