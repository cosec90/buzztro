    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
       ...
       <?php include '../Admin_modules/fetch_queries.php';
        ...
        foreach ($fetch_seller_enquiries as $key => $value) 
        {
          $number_of_results++;
        }
        ...
        $sql = "SELECT * FROM `seller_enquiry` WHERE `query_status` = 'Unsolved' LIMIT " . $starting_limit_number .','.$results_per_page;
        ...
        ?>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-lg-4">
                  <p>From: <?php echo $value['seller_company'];?></p>
                </div>
                <div class="col-lg-4">
                </div>
                <div class="col-lg-4">
              ...
              <div class="row">
                <div class="col-lg-12">
                  <textarea type="text" id="enquiry" name="enquiry" class="form-control" rows="5" readonly=""><?php echo strip_tags($value['seller_msg']);?></textarea>
                </div>
              </div>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <form action="../Admin_modules/fetch_queries.php?code=<?php echo $value['query_no'];?>&&type=seller" method="post"><button type="submit" class="btn_approve" name="close_query">Yes</button></form>
